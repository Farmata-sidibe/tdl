...
<div class="p-5 border rounded text-gray-500 flex justify-center items-center">
        <div class="bg-[#ffffff] rounded-xl shadow-lg w-[60vw] px-[40px] py-[50px] mt-[50px] mb-[50px]">
            ...
            <div class="mt-[20px]">
                <h2 class="text-[1.3em] font-bold">Edition du site</h2>
                <p>Le présent site, accessible à l’URL tout-doux-liste.fr (le « Site »), est édité par :

                    Farmata Sidibe, résidant 31 avenue jules valles 95490 Vauréal, de nationalité Sénégalaise (Sénégal), né(e) le 26/11/2000,
                </p>
            </div>

            <div class="mt-[20px]">
                <h2 class="text-[1.3em] font-bold">Hébergement</h2>
                <p>
                    Le Site est hébergé par la société 1&1 / IONOS, situé 7 Place de la Gare - 57200 Sarreguemines, (contact téléphonique ou email : (+33) 9 70 80 89 11).
                </p>
            </div>

            <div class="mt-[20px]">
                <h2 class="text-[1.3em] font-bold">Directeur de publication</h2>
                <p>
                    Le Directeur de la publication du Site est Farmata Sidibe.
                </p>
            </div>
