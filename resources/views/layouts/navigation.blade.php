<header class="antialiased">
    <nav class="bg-beige border-gray-200 px-4 lg:px-6 py-2.5 light:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">

                {{-- <button aria-expanded="true" aria-controls="sidebar" class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-900 hover:bg-white focus:bg-gray-100 light:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 light:focus:ring-gray-700 light:text-gray-400 light:hover:bg-white light:hover:text-white">
                ...
                <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                    ...
                    <div class="relative mt-1 lg:w-96">
                        ...
                        <input type="text" name="email" id="topbar-search"
                            class="bg-beige border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-primary-500 light:focus:border-primary-500"
            ...
            <div class="flex items-center lg:order-2">
                ...
                <button id="toggleSidebarMobileSearch" type="button"
                    class="p-2 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-white light:text-gray-400 light:hover:bg-gray-700 light:hover:text-white">
                ...
                <a href="cagnotte">
                    <div
                        class="px-[10px] py-[3px] ring-1 ring-[#DCD9D2] rounded-[7px] flex flex-row items-center justify-center hover:text-gray-900 hover:bg-white light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                ...
                <!-- Dropdown menu -->
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg light:divide-gray-600 light:bg-gray-700"
                    id="notification-dropdown">
                    <div
                        class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 light:bg-gray-700 light:text-gray-400">
                        Notifications
                    </div>
                    <div>
                        <a href="#"
                            class="flex py-3 px-4 border-b hover:bg-white light:hover:bg-gray-600 light:border-gray-600">
                    ...
                    <a href="#"
                        class="block py-2 text-base font-medium text-center text-gray-900 bg-gray-50 hover:bg-white light:bg-gray-700 light:text-white light:hover:underline">
                ...
                {{-- @section('content')
                    ...
                    <button type="button" data-dropdown-toggle="apps-dropdown"
                        class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-white light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                        <span class="sr-only">View notifications</span>
                        <!-- Icon -->
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg light:bg-gray-700 light:divide-gray-600"
                        id="apps-dropdown">
                        <div
                            class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 light:bg-gray-700 light:text-gray-400">
                            menu
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Sales</div>
                            ...
                            <a href="#"
                                class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Settings</div>
                            ...
                            <a href="product"
                                class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                                <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500 light:text-gray-400 light:group-hover:text-gray-400"
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow light:bg-gray-700 light:divide-gray-600"
                        id="dropdown">
                        <div class="py-3 px-4">
                        ...
                        <ul class="py-1 text-gray-500 light:text-gray-400" aria-labelledby="dropdown">
                            <li>
                                <a href="{{ route('dashboard') }}"
                                    class="block py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:text-gray-400 light:hover:text-white">Mon
                                    profil</a>
                            </li>
                            <li>
                                <a href="{{ route('profile.edit') }}"
                                    class="block py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:text-gray-400 light:hover:text-white">Paramêtre</a>
                            </li>
                        </ul>
                        {{-- <ul class="py-1 text-gray-500 light:text-gray-400" aria-labelledby="dropdown">
                          <li>
