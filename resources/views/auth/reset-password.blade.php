<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            {{-- <x-input-label for="password_confirmation" :value="__('Confirmer le Password')" /> --}}

            <x-text-input placeHolder="Confirmer le password" id="password_confirmation" class="block mt-1 w-full"
                                type="password"
