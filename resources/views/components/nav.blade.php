    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 light:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <button aria-expanded="true" aria-controls="sidebar" class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 light:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 light:focus:ring-gray-700 light:text-gray-400 light:hover:bg-gray-700 light:hover:text-white">
                ...
                <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                  ...
                  <div class="relative mt-1 lg:w-96">
                    <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-500 light:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/> </svg>
                    </div>
                    <input type="text" name="email" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-primary-500 light:focus:border-primary-500" placeholder="Rechercher un produit">
                  </div>
                </form>
              </div>
            <div class="flex items-center lg:order-2">
                <button type="button" class="hidden sm:inline-flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 light:bg-primary-600 light:hover:bg-primary-700 focus:outline-none light:focus:ring-primary-800"><svg aria-hidden="true" class="mr-1 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg> New Widget</button>
                <button id="toggleSidebarMobileSearch" type="button" class="p-2 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:bg-gray-700 light:hover:text-white">
                 ...
                 {{-- cagnotte --}}
                 <a href="cagnotte">
                    <div class="px-[10px] py-[3px] ring-1 ring-[#DCD9D2] rounded-[7px] flex flex-row items-center justify-center hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                        <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                        ...
                        <h3 class="text-[14px] text-gray-800">23€</h3>
                    </div>
                </a>
                <!-- Notifications -->
                <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                ...
                <!-- Dropdown menu -->
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg light:divide-gray-600 light:bg-gray-700" id="notification-dropdown">
                    <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 light:bg-gray-700 light:text-gray-400">
                        Notifications
                    </div>
                    <div>
                    <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 light:hover:bg-gray-600 light:border-gray-600">
                        {{-- <div class="flex-shrink-0">
                            ...
                            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700 light:border-gray-700">
                        ...
                        <div class="pl-3 w-full">
                            <div class="text-gray-500 font-normal text-sm mb-1.5 light:text-gray-400">New message from <span class="font-semibold text-gray-900 light:text-white">Bonnie Green</span>: "Hey, what's up? All set for the presentation?"</div>
                            <div class="text-xs font-medium text-primary-700 light:text-primary-400">a few moments ago</div>
                        </div> --}}
                    </a>

                    </div>
                    <a href="#" class="block py-2 text-base font-medium text-center text-gray-900 bg-gray-50 hover:bg-gray-100 light:bg-gray-700 light:text-white light:hover:underline">
                ...
                {{-- <a href="" class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600"> --}}
                    <input type="text" id="liste-url" value="{{ route('liste.showBySlug', $liste->slug) }}" readonly class="form-control mb-2">
                    <button id="copy-button" class="btn btn-secondary" onclick="copyToClipboard()">
                ...
                <!-- Apps -->
                <button type="button" data-dropdown-toggle="apps-dropdown" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 light:text-gray-400 light:hover:text-white light:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600">
                    <span class="sr-only">View notifications</span>
                    <!-- Icon -->
                ...
                <!-- Dropdown menu -->
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg light:bg-gray-700 light:divide-gray-600" id="apps-dropdown">
                    <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 light:bg-gray-700 light:text-gray-400">
                        menu
                    </div>
                    <div class="grid grid-cols-3 gap-4 p-4">
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Sales</div>
                    </a> --}}
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        @svg('addLink', ['width'=>'1.25rem', 'height'=>'1.25rem'])
                        {{-- <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500 light:text-gray-400 light:group-hover:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20"><path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/></svg> --}}
                        <div class="text-sm font-medium text-gray-900 light:text-white">Ajouter un produit</div>
                    </a>
                    ...
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Users</div>
                    </a> --}}
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                         ...
                         <div class="text-sm font-medium text-gray-900 light:text-white">Inbox</div>
                    </a> --}}
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Profile</div>
                    </a> --}}
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Settings</div>
                    </a> --}}
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Les indispensables</div>
                    </a>
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Pricing</div>
                    </a> --}}
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Billing</div>
                    </a> --}}
                    {{-- <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 light:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 light:text-white">Logout</div>
                    </a> --}}
                    </div>
                </div>
                <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 light:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow light:bg-gray-700 light:divide-gray-600" id="dropdown">
                    <div class="py-3 px-4">
                        <span class="block text-sm font-semibold text-gray-900 light:text-white">Neil sims</span>
                    ...
                    <ul class="py-1 text-gray-500 light:text-gray-400" aria-labelledby="dropdown">
                        ...
                        <li>
                            <a href="{{ route('profile.edit') }}" class="block py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:text-gray-400 light:hover:text-white">Paramêtre</a>
                        </li>
                    </ul>
                    {{-- <ul class="py-1 text-gray-500 light:text-gray-400" aria-labelledby="dropdown">
                          <li>
                            <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:hover:text-white">
                        ...
                        <li>
                            <a href="#" class="flex justify-between items-center py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:hover:text-white">
                                <span class="flex items-center">
                                    <svg class="mr-2 w-4 h-4 text-primary-600 light:text-primary-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="m7.164 3.805-4.475.38L.327 6.546a1.114 1.114 0 0 0 .63 1.89l3.2.375 3.007-5.006ZM11.092 15.9l.472 3.14a1.114 1.114 0 0 0 1.89.63l2.36-2.362.38-4.475-5.102 3.067Zm8.617-14.283A1.613 1.613 0 0 0 18.383.291c-1.913-.33-5.811-.736-7.556 1.01-1.98 1.98-6.172 9.491-7.477 11.869a1.1 1.1 0 0 0 .193 1.316l.986.985.985.986a1.1 1.1 0 0 0 1.316.193c2.378-1.3 9.889-5.5 11.869-7.477 1.746-1.745 1.34-5.643 1.01-7.556Zm-3.873 6.268a2.63 2.63 0 1 1-3.72-3.72 2.63 2.63 0 0 1 3.72 3.72Z"/></svg>
                                    Pro version
                                </span>
                    ...
                    {{-- <ul class="py-1 text-gray-500 light:text-gray-400" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-100 light:hover:bg-gray-600 light:hover:text-white">Sign out</a>
                        </li>
                    </ul> --}}
                      <!-- Authentication -->
